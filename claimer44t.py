...
# --- Configuration ---
API_ID = '28681433' # Your API ID
API_HASH = '3c7de846a7da9e2b3274ce2a13363471' # Your API Hash
GROUP_ID = -1002606862659 # Your corrected group ID
...
if len(sys.argv) > 1:
    ...
    SESSION_NAME = 'grabber_bot_default' # Default if no argument is provided
...
logging.basicConfig(
    ...
    level=logging.INFO,
    # Make log file unique to the session name
